...
function initThreeJS(containerId, modelURL) {
    ...
    // Load model
    loader.load(`assest/models/glb/${modelURL}`, (gltf) => {
...
initThreeJS('model1-container', 'lukas.glb');
initThreeJS('model2-container', 'mma kick.glb');
initThreeJS('model3-container', 'marco.glb');
initThreeJS('model4-container', 'syafa.glb');
